...
registers to hold 128-bit capabilities, known as a \textit{merged
register file}.
...
While the
implementation described in later chapters was initially mapped into the 64-bit MIPS ISA, the
\jhbnote{When can we make RISC-V the ``main'' ISA?}
overall CHERI strategy is intended to support a variety of ISA backends and
has been implemented in the 64-bit ARMv8 and 32-bit and 64-bit RISC-V ISAs with only
modest localization.
