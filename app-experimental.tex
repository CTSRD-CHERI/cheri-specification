...
\section{Capability-Aware Direct Memory Access (DMA)}
\label{app:exp:dma}
\input{app-exp-dma}
...
\item If this extension is not implemented, the bits taken by this extension have to be all ``1''s. This way, software that is oblivious to capability levels runs without any limitation to the flow of capabilities and does not pose any security risks.
