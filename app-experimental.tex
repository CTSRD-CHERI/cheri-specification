...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item Check whether the isentry can load a CAP-WIDTH wide word.
  \end{itemize}
  \item \insnnoref{CJAURLP}: CHERI jump and unseal into register linked pair; this instruction has one three operands of which one is explicit and the other two are implicit.
...
Thus the capability contents can be read, but the capability can be derefenced.
