...
\item Within a protection level, the CL levels have a total order such that given $C_{1}$ with CL=$L_{1}$ and $C_{2}$ with CL=$L_{2}$, if $L_{1}$ < $L_{2}$ $\rightarrow$ $C_{1}$ is more sensitive than $C_{2}$.
