...
We may call this new attribute PMAT (Physical Memory Attribute - Tagged), which indicates if this block can preserve tags in DRAM.
The PMAT for any block is set only through notification of the tag controller, which keeps it's own copy and notifies the Tag Filter to set PMAT for this block, after which the Tag Controller begins tracking tags for that block.
