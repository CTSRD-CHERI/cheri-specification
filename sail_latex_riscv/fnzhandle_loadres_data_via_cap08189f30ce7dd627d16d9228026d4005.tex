function #\hyperref[sailRISCVzhandlezyloadreszydatazyviazycap]{handle\_loadres\_data\_via\_cap}#(rd, auth_idx, auth_val, vaddrBits, width) = {
  ...
  if #\hyperref[sailRISCVznot]{not}#(auth_val.tag) then {
    ...
    #\hyperref[sailRISCVzTRzyAddress]{TR\_Address}#(addr, _) =>
      match (width) {
        BYTE => #\hyperref[sailRISCVzprocesszyloadres]{process\_loadres}#(rd, vaddrBits, #\hyperref[sailRISCVzmemzyread]{mem\_read}#(#\hyperref[sailRISCVzRead]{Read}#(Data), addr, 1, aq, aq & rl, false), is_unsigned),
        HALF => #\hyperref[sailRISCVzprocesszyloadres]{process\_loadres}#(rd, vaddrBits, #\hyperref[sailRISCVzmemzyread]{mem\_read}#(#\hyperref[sailRISCVzRead]{Read}#(Data), addr, 2, aq, aq & rl, false), is_unsigned),
        WORD => #\hyperref[sailRISCVzprocesszyloadres]{process\_loadres}#(rd, vaddrBits, #\hyperref[sailRISCVzmemzyread]{mem\_read}#(#\hyperref[sailRISCVzRead]{Read}#(Data), addr, 4, aq, aq & rl, false), is_unsigned),
        DOUBLE if sizeof(xlen) >= 64
             => #\hyperref[sailRISCVzprocesszyloadres]{process\_loadres}#(rd, vaddrBits, #\hyperref[sailRISCVzmemzyread]{mem\_read}#(#\hyperref[sailRISCVzRead]{Read}#(Data), addr, 8, aq, aq & rl, false), is_unsigned),
        _    => #\hyperref[sailRISCVzreportzyinvalidzywidth]{report\_invalid\_width}#(__FILE__, __LINE__, width, "handle_loadres_data_via_cap")
      }
  }
}
