...
mode, \RSP{} is always used as the stack pointer. We will allow selecting \RSB{} or \CSP{} using the alternate-addressing-mode prefix (0x07).
...
\begin{itemize}
  ...
  \item \insnnoref{ADDC} and \insnnoref{SUBC} would be used to adjust
    ...
    For these instructions, the source operand would either be a
